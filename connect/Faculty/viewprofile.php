...
?>
  ...
  padding-right: 5%;">
      <?php
                                                ...
                                                $ans=mysqli_fetch_array($res);
                                                        ...
                                                        $doj=date('d-m-Y',strtotime($ans['Doj']));
                                                        $contact=$ans['Contact'];
  ...
  <div class="container-fluid">
      <div class="row" style="background-color: white;width: 100%;">
            <div class="col-12">
                <div id="div1">
                                <div style="height: 180px;background-image: url(../img/bg-img/profile.jpg);"><img src="../img/profile/faculty/<?php  echo $img; ?>" id="img1" /><h5><img src="../img/core-img/camera.png" width="50" height="50" data-target="#changeprofile" data-toggle="modal" id="camera"/>Change Profile</h5></div>
      ...
      <div class="row" style="background-color: white;width: 100%;" id="display">
                <div class="col-sm-4">
                      <div id="div2">
                          <div style="height: 70px;text-align: center;padding-top: 15px;border-bottom: 1px solid;"><b>Name</b><br><?php  echo $name; ?></div>
                          <div style="height: 70px;text-align: center;padding-top: 15px;border-bottom: 1px solid;"><b>Username</b><br><?php  echo $uname; ?></div>
                ...
                <div class="col-sm-4">
                      <div id="div2">
                          ...
                          <div style="height: 70px;text-align: center;padding-top: 15px;border-bottom: 1px solid;"><b>Date-Of-Brith</b><br><?php  echo $dob; ?></div>
                          <div style="height: 70px;text-align: center;padding-top: 15px;border-bottom: 1px solid;"><b>Date-Of-Join</b><br><?php  echo $doj; ?></div>
                ...
                <div class="col-sm-4">
                      <div id="div2">
                          ...
                          <div style="height: 70px;text-align: center;padding-top: 15px;border-bottom: 1px solid;"><b>Qualification</b><br><?php  echo $qul; ?></div>
                          <?php
                           $q="Select Coursename from coursemst where Courseid=$dept";
                           $r=mysqli_query($cnn,$q);
                           $a=mysqli_fetch_array($r);
                           $deptname=$a['Coursename']; 
                          ?>
                          <div style="height: 70px;text-align: center;padding-top: 15px;border-bottom: 1px solid;"><b>Department</b><br><?php  echo $deptname; ?></div>
      ...
      <div class="row" style="background-color: white;width: 100%;" id="update">
                <div class="col-sm-4">
                      <div id="div4">
                        <form method="post" action="update.php" autocomplete="off">
                          <div style="height: 70px;text-align: center;padding-top: 15px;border-bottom: 1px solid;"><b>Name</b><br><input type="text"class="form-control text-info" name="txtname" value="<?php  echo $name; ?>"></div>
                          <div style="height: 70px;text-align: center;padding-top: 15px;border-bottom: 1px solid;"><b>Username</b><br><input type="text"class="form-control text-info" name="txtuname" value="<?php  echo $uname; ?>"></div>
                ...
                <div class="col-sm-4">
                      <div id="div4">
                          ...
                          <div style="height: 70px;text-align: center;padding-top: 15px;border-bottom: 1px solid;"><b>Date-Of-Birth</b><br><input type="text" class="form-control text-info" id="txtdob" name="dob" value="<?php  echo $dob; ?>"></div>
                         <div style="height: 70px;text-align: center;padding-top: 15px;border-bottom: 1px solid;"><b>Date-Of-Join</b><br><?php  echo $doj; ?></div>
                ...
                <div class="col-sm-4">
                      <div id="div4">
                          ...
                          <div style="height: 70px;text-align: center;padding-top: 15px;"><b>Qualification</b><br>
                                <input type="text" class="form-control text-info" id="txtqul" name="txtqul" value="<?php  echo $qul; ?>">
                                   
                            </div>
                          <div style="height: 70px;text-align: center;padding-top: 15px;border-bottom: 1px solid;"><b>Department</b><br>
                                      <select name="txtdept" class="form-control text-info" id="txtdept">
                                        <?php
                                          ...
                                          {
                                            if($ans['Courseid']==$dept)
                                            {
                                              echo "<option selected>".$ans['Coursename']."</option>";
                                            }
                                            else
                                            {
                                                echo "<option>".$ans['Coursename']."</option>";
                                            }
                                          }
                                        ?>
                                      </select>
                ...
                <div class="col-lg-9">
                      <div style="margin-top: 10px;margin-bottom: 0px;background-color: white;box-shadow: 5px 10px 8px #888888;width: 650px;height: 400px;">
                              ...
                              <div style="width: 650px;height: 55px;background-color:#b3b3ff;">
                                <img src="../img/profile/faculty/<?php  echo $img; ?>" id="img4" />&nbsp;&nbsp;&nbsp;<font color="#0000ff"><?php  echo $name; ?></font>&nbsp;&nbsp;&nbsp;
...
<!--Modal start-->
      ...
      <?php
          if(isset($_REQUEST['btnchange']))
          {
            ...
            $img=$id.".".$ext[1];
            echo $img;
            $query="UPDATE teachermst set Profile='$img' where Teacherid=$id";
            $cnt=mysqli_query($cnn,$query);
                
             if($cnt>0)
            {
              move_uploaded_file($_FILES['img']['tmp_name'],'../img/profile/faculty/'.$img);
