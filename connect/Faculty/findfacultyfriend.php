  ...
  <div class="container-fluid" style="background-color: white;box-shadow: 5px 10px 8px #888888;">
        <div class="row" style="background-color: white;">
          ...
          <?php
                  ...
                  $q1="SELECT * from teachermst  where Teacherid!=$sid and facultystatus!='left' ";
...
<?php 
            if(isset($_REQUEST['frd']))
            {
                ...
                $rid1=$_REQUEST['rid'];
                $time=time();
                $q3="INSERT into teacherfriendmst (Sender,Receiverteacher,Time) values($sid1,$rid1,'$time')";
            ...
            if(isset($_REQUEST['can']))
            {
                $sid2=$_REQUEST['sid'];
                $rid2=$_REQUEST['rid'];
                $q4="DELETE from teacherfriendmst where Sender=$sid2 and Receiverteacher=$rid2";
