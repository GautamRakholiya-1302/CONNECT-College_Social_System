...
{
  $em=$_REQUEST['email'];
  $query = "SELECT * FROM teachermst WHERE Email='$em'";
  ...
  if($num==0)
  {
        ...
        window.location = \"facultylogin.php?Err=true\"
        </script>";
  }
  else
  {
                ...
                ?>
                    ...
                    <div class="col-12">
                        <div id="div1" class="forms">
                            <h4 class="text-primary">Faculty Login</h4>
                            <form  action="chkfacultylogin.php" autocomplete="off" method="post">
                                <div class="row">
                                    <div class="col-12 col-lg-6">
                                        <div class="form-group">
                                            <input type="text"   class="form-control text-info" name="txtname" id="text" placeholder="UserName" required>
                                        </div>
                                    </div>
