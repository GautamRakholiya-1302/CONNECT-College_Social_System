...
<?php
      if(isset($_REQUEST['save']))
      {
          ...
          $id=$_SESSION['stud_id'];
          $query="SELECT Pwd from studentmst where Studentid=$id";
          ...
          if($pswd==$old)
          {
              if($new==$rep)
              {
                  ...
                  $query="UPDATE studentmst set Pwd='$pw' where Studentid=$id";
                  $res=mysqli_query($cnn,$query);
...
<section class="register-now section-padding-100 d-flex justify-content-between align-items-center" style="background-image: url(img/core-img/texture.png);">
  ...
  <div class="container-fluid">
      <div class="row" style="margin-left: 27%;width: 700px; background-color: white;box-shadow: 5px 10px 8px #888888;padding-top: 5px;padding-bottom: 5px;">
