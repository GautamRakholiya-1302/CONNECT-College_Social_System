 	...
 	<div class="container-fluid" style="background-color: white;box-shadow: 5px 10px 8px #888888;">
          ...
          <form>
            ...
            <?php 
                ...
                $id=$_SESSION['stud_id'];
                $query1="SELECT * from studentfriendmst where Receiverstudent=$id and Status=0";
            ...
            <div class="col-sm-6">
                <div id="div1">
                                ...
                                <span id="s1"><strong><?php echo $time = time_stamp($time); ?></strong></span>
                                 ...
                                 <a href=""   class="btn  btn-danger w-10 cancel"  role="button"  name="cancel1" id="<?php echo $sid; ?>"><i class="fa fa-times" aria-hidden="true"></i></a></span>
                               </form>
                       </div>       
                </div>
            <?php 
        ...
        <?php
            if(isset($_REQUEST['con2']))
            {
              $sid=$_REQUEST['sid'];
              $rid=$_REQUEST['rid'];
              $q1="UPDATE studentfriendmst set Status=1 where Sender=$sid and Receiverstudent=$rid ";
