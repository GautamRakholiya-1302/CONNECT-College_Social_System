    ...
    <div class="container">
            <div class="col-12">
                    <table class="table table-hover" style="background-color: white;">
                            ...
                            <tbody id="myTable">
                            <?php
                                    $query="SELECT * from postmst  where Teacherid!='NULL' and Postimg!='NULL' ";
            ...
            <table class="table table-hover" style="background-color: white;">
                    ...
                    <tbody id="myTable">
                    <?php
                            $query="select * from postmst  where Teacherid!='NULL' and Postvideo!='NULL' ";
                            $res=mysqli_query($cnn,$query);
                            while($ans=mysqli_fetch_array($res))
                            {
                                    $postid=$ans['Postid'];
         ...
         <div class="col-12">
            <table class="table table-hover" style="background-color: white;">
                    ...
                    <tbody id="myTable">
                    <?php
                            $query="select * from postmst  where Teacherid!='NULL' and Postaudio!='NULL' ";
                            $res=mysqli_query($cnn,$query);
                            while($ans=mysqli_fetch_array($res))
                            {
                                    $postid=$ans['Postid'];
